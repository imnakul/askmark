...
export function ExpandableCardDemo() {
   ...
   return (
      <>
                  ...
                  >
                     ...
                     >
                        <img
                           ...
                           src={active.src}
                           alt={active.title}
                           className='w-96 h-72 p-2 sm:rounded-tr-lg sm:rounded-tl-lg object-cover object-top'
                        />
                     </motion.div>
         ...
         <ul className='max-w-8xl mx-auto w-full grid grid-cols-1 md:grid-cols-3 items-start gap-3'>
            {cards.map((card, index) => (
               <motion.div
                  layoutId={`card-${card.title}-${id}`}
                  key={card.title}
                  onClick={() => setActive(card)}
                  className='p-4 flex flex-col  hover:bg-neutral-50 dark:hover:bg-cyan-700 rounded-xl cursor-pointer  transition-all duration-300 ease-in-out hover:scale-105'
               >
      ...
      content: () => {
         return (
            <p>
               ...
               audience. Born in the village of Khant Maanpur in Punjab, India,
               he has become a cultural icon in the Punjabi music industry.{' '}
               <br /> <br />
               ...
               With a career spanning over two decades, Babu Maan has released
               numerous hit albums and singles that have garnered him a massive
               fan following both in India and abroad.
            </p>
         )
      },
   },
      ...
      content: () => {
         return (
            <p>
               ...
               their powerful sound and intense performances that resonate
               deeply with their audience. Formed in Los Angeles, California,
               they have become a cultural icon in the heavy metal music
               industry. <br /> <br />
               Their songs often reflect themes of aggression, social issues,
               and personal struggles, capturing the essence of the heavy metal
               genre. With a career spanning over four decades, Metallica has
               released numerous hit albums and singles that have garnered them
               a massive fan following both in the United States and abroad.
            </p>
         )
      },
   },
