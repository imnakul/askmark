               ...
               >
                  ...
                  <div className='flex min-h-full items-center justify-center p-4'>
                     <motion.div
                        ...
                        animate='visible'
                        exit='exit'
                        className={`relative transform overflow-hidden rounded-lg backdrop-blur-lg  px-3 pt-1 pb-3 text-left shadow-xl w-[80vw] sm:w-full sm:max-w-xl sm:p-6 bg-cyan-700/60`}
                     >
                        {/* Close Button */}
