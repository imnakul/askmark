...
const socials = [
   {
      ...
      icon: <Github className='size-7 text-gray-900 dark:text-gray-300' />,
   },
   {
      social: 'linked-In',
      url: 'https://www.linkedin.com/in/nakul-srivastava-a7426033b',
      icon: <Linkedin className='size-7 text-gray-900 dark:text-gray-300' />,
   },
   {
      social: 'twitter',
      url: 'https://x.com/imnakul_1?t=kE6SVznWCPS3rCFFUEXPAg&s=09',
      icon: <Twitter className='size-7 text-gray-900 dark:text-gray-300' />,
   },
]
