...
const socials = [
   {
      ...
      icon: <Github className='size-7 text-gray-300 ' />,
   },
   {
      social: 'linked-In',
      url: 'https://www.linkedin.com/in/nakul-srivastava-a7426033b',
      icon: <Linkedin className='size-7 text-gray-300' />,
   },
   {
      social: 'twitter',
      url: 'https://x.com/imnakul_1?t=kE6SVznWCPS3rCFFUEXPAg&s=09',
      icon: <Twitter className='size-7 text-gray-300' />,
   },
]
...
function ContactDetails() {
   return (
      <div className='glass-effect bg-black/30 rounded-xl p-2 card-glow h-full'>
         <p className=' text-gray-300 mb-6 inter'>
         ...
         <div className='space-y-4'>
            <div className='flex items-center justify-between'>
               <div className='flex items-center'>
                  <div className={`w-10 h-10 rounded-full  flex items-center justify-center mr-2 md:mr-4`}>
                     <svg
                  ...
                  <span className='text-gray-300 inter'>Nakul Srivastava</span>
               </div>
               <a
            ...
            <div className='flex items-center '>
               ...
               <span className='text-gray-300 inter'>imnakul44@gmail.com</span>
               <a
            ...
            <div className='flex items-center'>
               ...
               <span className='text-gray-300 inter'>Meerut, INDIA</span>
            </div>
         </div>
