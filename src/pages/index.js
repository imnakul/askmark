...
function Index() {
   ...
   return (
      <>
         <HeroHighlight containerClassName='bg-gradient-to-tr from-[#0a0f1c] via-[#101a2b] to-[#1a2236] min-h-screen'>
            <motion.h1
               initial={{ opacity: 0, y: 20 }}
               animate={{ opacity: 1, y: [20, -5, 0] }}
               transition={{ duration: 0.5, ease: [0.4, 0.0, 0.2, 1] }}
               className='text-2xl px-4 md:text-4xl lg:text-5xl font-bold text-neutral-200 dark:text-white max-w-4xl leading-relaxed lg:leading-snug text-center mx-auto drop-shadow-lg'
            >
